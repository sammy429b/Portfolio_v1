  ...
  <>
    ...
    <div className='flex'>
      <div className="lg:w-1/2 ont-Poppins w-full h-[41.4rem] bg-[#0A192F] pb-24 flex flex-col pl-[7rem] gap-y-1 text-left lg:items-start justify-center">
        ...
        <h1 className="font-Poppins text-[2.3rem] lg:text-[3rem] text-[#16502D] font-semibold leading-none">Samarth Bahirgonde</h1>
        ...
        <div className='items-center justify-center w-[9rem] h-[4rem] text-[#8892B0] gap-x-4 flex text-[2rem] mt-2 '>
