const About = () => {
  return (
    <>
      <div className="w-full h-[44.6rem] bg-[#FFFFFF] gap-y-8 pb-12 flex flex-col justify-center items-center" id="about">
            ...
            <div className="w-[40rem]">
                <p className="text-justify text-[#666666] text-[1.2rem] font-normal">Hey! My name is Samarth and I&#39;m a web developer with a passion for front end development and design. I&#39;m currently a third year student at <a href="https://www.mmcoe.edu.in/" className="text-[#00009C]">Marathwada Mitra Mandal&#39;s College of Engineering</a> pursuing a degree in computer science. Adept at identifying opportunities to enhance front-end skill and improve the user experience.</p>
            </div>
