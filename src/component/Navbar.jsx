    ...
    return (
        <>
            <header className="w-full  h-[5rem] flex justify-between px-2 items-center bg-[#F0F0F0]">
                ...
                <div className={`z-10 fixed md:static top-20 bottom-0 pt-6 pl-8 space-y-10 bg-[#0A192F] lg:text-black md:text-black sm:text-black text-white w-[100%] left-0 md:w-3/6 md:flex md:space-y-0 justify-between items-center md:bg-[#F0F0F0] transition-all delay-400 ${isOpen ?'hidden' : 'top-20'}`}>
